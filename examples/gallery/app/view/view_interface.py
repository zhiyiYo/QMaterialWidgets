...
class ViewInterface(GalleryInterface):
    ...
    def __init__(self, parent=None):
        ...
        self.addExampleCard(
            ...
            sourcePath='https://github.com/zhiyiYo/QMaterilWidgets/blob/PySide6/examples/table_view/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            sourcePath='https://github.com/zhiyiYo/QMaterilWidgets/blob/PySide6/examples/list_view/demo.py'
        )
