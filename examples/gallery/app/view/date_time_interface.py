...
class DateTimeInterface(GalleryInterface):
    ...
    def __init__(self, parent=None):
        ...
        self.addExampleCard(
            ...
            sourcePath='https://github.com/zhiyiYo/QMaterialWidgets/blob/PySide6/examples/calendar_picker/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            sourcePath='https://github.com/zhiyiYo/QMaterialWidgets/blob/PySide6/examples/date_time/demo.py'
        )
