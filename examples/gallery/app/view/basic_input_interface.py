...
class BasicInputInterface(GalleryInterface):
    ...
    def __init__(self, parent=None):
        ...
        self.addExampleCard(
            ...
            'https://github.com/zhiyiYo/QMaterialWidgets/blob/PySide6/examples/button/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            'https://github.com/zhiyiYo/QMaterialWidgets/blob/PySide6/examples/check_box/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            'https://github.com/zhiyiYo/QMaterialWidgets/blob/PySide6/examples/combo_box/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            radioWidget,
            'https://github.com/zhiyiYo/QMaterialWidgets/blob/PySide6/examples/radio_button/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            slider,
            'https://github.com/zhiyiYo/QMaterialWidgets/blob/PySide6/examples/slider/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            self.switchButton,
            'https://github.com/zhiyiYo/QMaterialWidgets/blob/PySide6/examples/switch_button/demo.py'
        )
        ...
        self.addExampleCard(
            self.tr('Input chip'),
            w,
            'https://github.com/zhiyiYo/QMaterialWidgets/blob/PySide6/examples/chip/demo.py'
        )
