...
class NavigationViewInterface(GalleryInterface):
    ...
    def __init__(self, parent=None):
        ...
        self.addExampleCard(
            ...
            sourcePath='https://github.com/zhiyiYo/QMaterialWidgets/blob/PyQt6/examples/navigation_bar/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            sourcePath='https://github.com/zhiyiYo/QMaterialWidgets/blob/PyQt6/examples/tab_widget/demo.py',
        )
