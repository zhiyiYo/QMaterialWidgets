...
class StatusInfoInterface(GalleryInterface):
    ...
    def __init__(self, parent=None):
        ...
        self.addExampleCard(
            ...
            button,
            'https://github.com/zhiyiYo/QMaterialWidgets/blob/PySide2/examples/tool_tip/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            w,
            'https://github.com/zhiyiYo/QMaterialWidgets/blob/PySide2/examples/info_bar/demo.py'
        )
        ...
        card = self.addExampleCard(
            ...
            bar,
            'https://github.com/zhiyiYo/QMaterialWidgets/blob/PySide2/examples/progress_bar/demo.py',
        )
        ...
        self.addExampleCard(
            ...
            ring,
            'https://github.com/zhiyiYo/QMaterialWidgets/blob/PySide2/examples/progress_ring/demo.py',
        )
